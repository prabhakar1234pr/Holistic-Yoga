    ...
    <footer className="bg-gray-900 text-white py-16">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              <li>
                <a href="#offerings" className="hover:text-emerald-400 transition-colors text-lg">
                  Our Offerings
                </a>
              </li>
              <li>
                <a href="#testimonials" className="hover:text-emerald-400 transition-colors text-lg">
                  Testimonials
                </a>
              </li>
              <li>
                <a href="#about" className="hover:text-emerald-400 transition-colors text-lg">
                  About
                </a>
              </li>
            </ul>
        ...
        <div className="text-center text-gray-400">
          <p className="text-lg">&copy; {new Date().getFullYear()} Holistic Yoga. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
